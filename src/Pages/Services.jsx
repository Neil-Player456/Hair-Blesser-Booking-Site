...
const hairstyles = [
  ...
  },
  {
    ...
    image: style8,
    variations: ["Smedium Mid Length", "Smedium Waist Length", "Smedium Butt Length", "Smedium Mid Length", "Medium Waist Length", "Medium Butt Length", "Bring your own Locs"],
    disclaimer: "This is with human curls attached to the locs. A $60 deposit is needed at least 48HRS before your appointment. Pease have hair washed - blow dried.",
  },
      {
    name: "Mini Twist",
    image: style8,
    variations: ["Mini Twist on Natural hair", "Mini Twist W/Added Synthetic hair", "Mini Twist W/Added Human hair", "Bring your own human hair"],
    disclaimer: "Pease have hair washed - blow dried. The hair that is added is Spring Twist Hair or Human Hair. Mini twist W/Human hair is up to 8in anything longer is an extra cost. if you would like them bidder than micro/mini price is decreased $120 non refundable deposit W/Human hair.",
  },
      {
    name: "Butterfly Loc",
    image: style8,
    variations: ["Smedium Waist", "Smedium Mid Length", "Medium Waist Length", "Medium Mid Length"],
    disclaimer: "Pease have hair washed - blow dried.",
  },
      {
    name: "Fulani Braid Services",
    image: style8,
    variations: ["BOHO Waist Length", "No BOHO Waist Length", "BOHO Mid Back Length", "No BOHO Mid Back Length", "Sew In (In the Back)", "Crochet In The Back"],
    disclaimer: "Hair included. Pease have hair washed - blow dried.",
  },
      {
    ...
    image: style8,
    variations: ["5 Stich Braids", "6 Stich Braids", "7 Stich Braids", "8 Stitch Braids", "10 Or More Stich Braids"],
    disclaimer: "I provide hair for $10 extra up to waist length, anything longer is an extra $20 charge. Pease have hair washed - blow dried.",
  },
      {
    ...
    name: "Bora Braids",
    image: style8,
    variations: ["Medium Mid Back Length", "Medium Waist Length", "Smedium BOB", "Smedium Mid Back", "Smedium Waist Length", "Small BOB"],
    disclaimer: "Hair included. Pease have hair washed - blow dried. These are similar to BOHO Knotless except you can not see the braids. Usually 7-10 piexed of curls added to each braid. Requires $100 non refundable deposit due at least 48HRS before. Please Reach Out.",
  },
      {
    ...
    name: "Part & Start",
    image: style8,
    variations: ["Medium Waist Length", "Smedium Waist Length", "Small Waist Length", "Xsmall Waist Length"],
    disclaimer: "Hair included. Pease have hair washed - blow dried. Up to waist length. Anything longer is extra. Clips not included. Clips + $10. If you are wanting anything longer than waist length please send me a text or email to let me know.",
  },
      {
